-- PAPSKY REPORT PLAYER KATEGORI TERPISAH
...
ScreenGui.Name = "Papsky_banned_player"
...
Title.Text = "GILBERT REPORT PLAYER"
...
-- Helper function for category title
...
-- Helper function for report text

local function createReport(text)

    local Box = Instance.new("TextButton", Scroll)

    Box.Size = UDim2.new(1,0,0,45)

    Box.TextWrapped = true

    Box.Text = "[CLICK TO COPY] "..text
...
-- ===== CATEGORY: BERKENCAN SEX =====

createCategory("Berkencan Sex")
...
-- ===== CATEGORY: ORANG TIDAK PANTAS =====

createCategory("Report Orang Tidak Pantas")
